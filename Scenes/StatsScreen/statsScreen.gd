...
var current_replication_value = 100
var current_locomotion_value= 100
var current_helper_value= 100
var current_manipulation_value= 100
var current_sensing_value= 100
var current_component_value= 100
var current_construction_value= 100
var current_deconstruction_value= 100
var current_ate_value= 100

var max_replication_value =2000
var max_locomotion_value=100
var max_helper_value=100
var max_manipulation_value=100
var max_sensing_value=100
var max_component_value = 100
var max_construction_value = 100
var max_deconstruction_value = 100
var max_ate_value = 100

var maxBarGene1Size= 0
...
func _set_current_bar():
	current_replication_value = 10
	var currentBarSize = current_replication_value + current_locomotion_value + current_helper_value + current_manipulation_value + current_sensing_value + current_component_value + current_construction_value + current_deconstruction_value + current_ate_value;
...
func _set_max_bar():
	...
	var maxBarSize = max_replication_value + max_locomotion_value + max_helper_value + max_manipulation_value + max_sensing_value + max_component_value + max_construction_value + max_deconstruction_value + max_ate_value;
	var thisSize = 550 - 100
...
func _set_values():
	...
	$sub1/gene2/score/Label.text = str(current_locomotion_value)
	$sub1/gene3/score/Label.text = str(current_helper_value)
	$sub1/gene4/score/Label.text = str(current_manipulation_value)
	$sub1/gene5/score/Label.text = str(current_sensing_value)
	$sub1/gene6/score/Label.text = str(current_component_value)
	$sub1/gene7/score/Label.text = str(current_construction_value)
	$sub1/transposon2/score/Label.text = str(current_deconstruction_value)
